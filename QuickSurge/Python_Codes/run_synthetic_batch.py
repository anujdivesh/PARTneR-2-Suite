...
input_folder = '/media/judith/10TB1/ECIKS/synthetic_TCs_Rarotonga/common_5d/'
## tide model
#tide_model_dir = '/media/judith/10TB1/QuickSurge/Tides/'
output_locations_csv1 = input_folder + 'eval_ptos.csv'
outfilename1 = 'point_results.csv'

# read list of selected storm
df = pd.read_csv('/media/judith/10TB1/ECIKS/synthetic_TCs_Rarotonga/common_5d/synthetic_TCs_Rarotonga.csv', header=None)
...
for itc in range(10):#range(0,tcs.max()):
