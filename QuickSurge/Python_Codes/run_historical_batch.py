...
input_folder = '/media/judith/10TB1/ECIKS/historic_TCs_Rarotonga/common_5d/'
## tide model
tide_model_dir = '/media/judith/10TB1/QuickSurge/Tides/'
output_locations_csv1 = input_folder + 'eval_ptos_0_360.csv'
...
for itc in range(1,2):#len(df.id)):
